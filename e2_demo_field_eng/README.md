...
The 'e2_demo_field_eng' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/e2_demo_field_eng/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] e2_demo_field_eng_etl` to your workspace.
